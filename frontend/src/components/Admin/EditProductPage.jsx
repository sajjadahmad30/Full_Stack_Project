  ...
  return (
    <div className="max-w-5xl mx-auto p-6 shadow-md rounded-md ">
        ...
        <form onSubmit={handleSubmit}>
            {/* name */}
            <div className="mb-6">
                <label htmlFor="" className='block font-semibold mb-6'>Product Name</label>
                <input type="text"
                name="name" 
            ...
            {/* description */}
            <div className="mb-6">
                <label htmlFor="" className='block font-semibold mb-6'>Description</label>
            ...
            <button type='submit'
            className='bg-green-500 w-full text-white p-2 rounded-md hover:bg-green-600 transition-colors'>Update Product</button>
        </form>
    </div>
  )
}
