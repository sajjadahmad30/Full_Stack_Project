    ...
    <footer className='border-t py-12 '>
        <div className="container mx-auto grid grid-cols-1  md:grid-cols-4 gap-8 px-4 lg:px-0">
            <div className="">
                ...
                <p className='text-sm font-medium text-gray-600 mb-6'>Sign up and get 10% off your first order.</p>
                ...
                <form className="flex">
                  ...
                  required/>
                  <button type='submit' className='bg-black text-white px-4 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all'>Subscribe</button>
                </form>
            </div>
            ...
            <div className="">
                ...
                <ul className='space-y-2 text-gray-600'>
                    ...
                    <li><Link to="#" className='hover:text-gray-500 transition-colors'>Womem's Top Wear</Link></li>
            ...
            <div className="">
                ...
                <div className="flex items-center space-x-4 mb-6">
                    <a href="http://www.facebook.com" target='_blank' rel='noopener noreferrer' className='hover:text-gray-500'>
                ...
                <p><FiPhoneCall className='inline-block mr-2'/>03014898897</p>
            </div>
        </div>
        {/* footer bottom */}
