   ...
   <div className="flex">
        <div className="flex flex-col w-full md:w-1/2 justify-center items-center p-8 md:p-12">
            <form onSubmit={handleSubmit} className='w-full max-w-md bg-white p-8 rounded-lg border shadow-sm'>
                ...
                <button type='submit' className='w-full bg-black text-white p-2 font-semibold rounded-lg hover:bg-gray-800 transition cursor-pointer'>Sign In </button>
        ...
        <div className="hidden md:block w-1/2 bg-gray-800">
            <div className="h-full flex flex-col justify-center items-center">
                <img src={login} className='w-full h-[750px] object-cover' />
            </div>
        </div>
   </div>
  )
