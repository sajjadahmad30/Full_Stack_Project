    ...
    try {
        ...
        if(productIndex > -1){
            ...
            if(quantity > 0){
                ...
                cart.products.splice(productIndex, 1); //remove product is qunatity is 0
            }
...
//desc merge guest cart into cart on login
//access private
                ...
                guestCart.products.forEach((guestItem)=>{
                    const productIndex = userCart.products.findIndex(
                        (item)=>
                            ...
                            item.size === guestItem.size && item.color === guestCart.color
                        );
                        ...
                        if(productIndex > -1){
                            ...
                            //otherwise add the the guest item to the cart
